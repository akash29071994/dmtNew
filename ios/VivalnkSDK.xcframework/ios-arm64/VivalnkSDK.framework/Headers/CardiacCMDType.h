...
typedef NS_ENUM(NSInteger, Cardiac_CommandType) {
    ...
    cardiac_clearAccStepCounts,                     ///15
    cardiac_readAccStepCounts,                      ///16
    
    cardiac_allowAccSamplingInLeadoff=100,          ///100
    cardiac_disallowAccSamplingInLeadoff,           ///101
    
    cardiac_allowAccSampling,                       ///102
    cardiac_disallowAccSampling                     ///103
};
