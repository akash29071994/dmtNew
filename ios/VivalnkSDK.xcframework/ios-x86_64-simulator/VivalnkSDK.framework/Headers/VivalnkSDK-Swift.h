...
#ifndef VIVALNKSDK_SWIFT_H
#define VIVALNKSDK_SWIFT_H
...
typedef SWIFT_ENUM(NSInteger, VVDFUError, open) {
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(uint8_t, VVDFUFirmwareType, open) {
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, VVDFUState, open) {
...
/// DFU UUID object.
SWIFT_CLASS("_TtC10VivalnkSDK9VVDFUUuid")
@interface VVDFUUuid : NSObject
...
///
- (nonnull instancetype)initWithCustomUuids:(NSArray<VVDFUUuid *> * _Nonnull)uuids;
@end


/// UUID Types for DFU.
typedef SWIFT_ENUM(NSInteger, VVDFUUuidType, open) {
/// Legacy DFU Service.
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, VVLogLevel, open) {
  VVLogLevelDebug = 0,
  VVLogLevelVerbose = 1,
  VVLogLevelInfo = 5,
